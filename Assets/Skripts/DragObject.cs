...
public class DragObject : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    private DragAndDropManager manager; // Reference to the DragAndDropManager
    ...
    private void Awake()
    {
        ...
        // Get the DragAndDropManager component
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (dropTarget != null && IsValidDropTarget(dropTarget.name))
        {
            ...
            // Check if manager is not null before calling CheckAllPlaced
            if (manager != null)
            {
                manager.CheckAllPlaced();
            }
            else
            {
    ...
    {
        return isDraggable; // Returns whether the object is draggable
    }
